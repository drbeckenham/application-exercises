...
We find this by using the R code nrow(bechdel90_13).
...
It would appear that people seem to prefer male movie stars, or male oriented movies over those that are female dominated. 
...
**Your answer:** The highest median budget is found in the notalk category, where the women don't talk to each other.

**Task 3.2:** Which category has the highest median international gross?

**Your answer:** The highest median international budget is also the notalk catefory, where the women don't talk to each other.
...
**Your answer:** Paranirmal Activity has the highest ROI. They made 671 dollars for every dollar.
...
This doesn't surprose me at all. Paranormal is a hot topic in the culture today. These types of movies are generally low budget, and don't require a huge outlay to make. They are fun to watch. Everyone loves a jump scare.
...
Outliers make analyzing difficult. You often hav to exclude the outliers or zoom in to see more accurate results.
---
...
**Your answer:** 3 movies have ROI greater than 400

**Task 5.3:** What do you notice about the budgets of these high-ROI movies?

**Your answer:**

The smaller the budget in most cases means the higher the ROI.Each of these big movies, including the top grosser of Paranormal Activity, cost less than a million to make.
---
...
ggplot(data = bechdel90_13, 
  ...
  labs(
    title = "Return on investment vs. Bechdel test result",
    subtitle = "Focusing on movies with an ROI of less than 15", # Something about zooming in to a certain level
    x = "Detailed Bechdel result",
...
**Your answer:** The category of "OK" has the highest median ROI

**Task 7.2:** Do movies that pass the Bechdel test (binary = PASS) appear to have higher or lower ROI than those that fail?

**Your answer:**

Those that pass appear to have a higher ROI than those that fail, but I do believe that there are many other factors to consider, like season of release and economic climate.

**Task 7.3:** What does this suggest about the financial argument for including women in films?

**Your answer:**
On the surface, it would seem to uplift the women in movies argument. More women in meaningful roles often means better ROI. Again, I don't think you can make this claim fully, however because of so many other factors, like seasn of release and economic situation.
---
...
The results are similar, where the FAIL category surpasses the PASS category. This is interesting, as you would expect something different based on the box olot done previously.
