...
**How many observations (bookings) are in the dataset?** There are 119390 observations in the .csv.
**How many variables are there?** There are 32 columns/variables in the .csv.

**What is the data type of the `hotel` variable?** The hotel data type is numeric.

**What is the data type of the `lead_time` variable?** The lead_time variable is numeric.

**How many missing values does the `children` variable have?** The "children" variable has 0 missing values.
...
There are a lot, but when you compare it to the overall number of reservations, it is only 5% of the total reservations. 
---
...
**Your answer:** About 7.8% of bookings include children or babies.
...
**Your prediction:** I think resort hotels will have more bookings with children/babies because resorts tend to cater to the whole family, and can be found in desireable locations. City hotels usually cater to the business traveller.
...
**Number of resort hotel bookings with children/babies:** 3929
...
**Number of city hotel bookings with children/babies:** 5403

**Task 4.4:** Which hotel type has more bookings with children/babies? Was your prediction correct?

**Your answer:**

It appears that the city hotels have more family bookings, which was a big surprise. My prediction was incorrect.
...
I am surprised at the solo travellers. It is the second highest, and this is a big surprise. The overall bookings number do make sense, with most people travelling with a companion, and there being smaller ammounts of bookings for larger groups.It is wierd that there are a bunch of bokings with 0 adults. I would guess these are erroneous
...
The unusual values (like 0 adults) appear more frequently in not cancelled bookings. This suggests that the bookings with 0 adults is centered around cancelled bookings. Therefore, they were probably made in error, or had some other erroneous data attached.
...
The city hotel has the highest average rate, with the median of 99.9 as opposed to the resort hotel with 75.0.
**Task 7.3:** What unusual values do you notice in the summary statistics?

**Your answer:**

I found that the minimum for the resort being a negative number very unusual. I think there must be some error in the data that has caused it. This would throw off all the numbers possibly.

**Hint:** Look at the minimum and maximum values. Are they realistic?

I don't think they are realistic. There is too much variance. I think the data has issues.
...
I would think that this is a data error. Another possibility is this was a complementary stay, but that doesnt account for it really. Perhaps it was an overpayment that wasn't returned. My money is on the data error.
...
Unless this booking was for the penthouse for a long period, which we don't know by ehat we have looked at, this is also probably a data error.

**Task 8.3:** Should these unusual values be removed from the dataset? Why or why not?

**Your answer:**

They are definitly outliers. Yes, they probably are errors and should be cleaned from the dataset.They are probably throwing off other stats.
